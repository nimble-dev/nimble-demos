...
Here we lay out how to do the steps manually. The [function `nimbleParallelMCMC` (available here)](https://github.com/nimble-dev/nimble-demos/blob/master/parallelization/parallelizingNimble.R) provides a wrapper function to do this easily in one function call.
