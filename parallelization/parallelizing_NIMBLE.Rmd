...
* A **socket** approach creates entirely separate 

Forking is often preferred to socketing, the latter of which introduces communication overhead that can slow things down. However, **socketing is the preffered approach for parallelizing in NIMBLE** because it creates separate environments in which NIMBLE objects, both visible and invisible, don't conflict.
