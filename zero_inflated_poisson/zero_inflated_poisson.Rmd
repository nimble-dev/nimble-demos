...
### Write the model to user the dZIP distribution we plan to write
...
Here there is nothing more than the parameters p and lambda and the data y.
...
* Everything else is here is like R.
* In a user-defined distribution, we must define a log argument indicating whether to return the probability or the log probability, as is standard in R's distribution functions.
