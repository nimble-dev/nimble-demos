...
* In a user-defined distribution, we must define a log argument indicating whether to return the probability or the log probability, as is standard in R's distribution functions.  Also the first arugument, representing a value of the random variable, must be named "x", which again is like R's distribution functions.
