...
Note that as of NIMBLE version 1.4.0, one could also potentially carry out this kind of calculation using a "derived quantity", as discussed in [Section 7.2.3 of the NIMBLE User Manual](https://r-nimble.org/manual/cha-mcmc.html#sec:derived-quantities).
