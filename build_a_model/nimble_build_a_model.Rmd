...
NIMBLE accommodates most of BUGS, but it doesn't yet handle stochastic indices (indices that are random variables).  It also extends the BUGS language in a bunch of ways that we won't go into here. See the [User Manual](https://r-nimble.org/html_manual/cha-welcome-nimble.html) for more details.
