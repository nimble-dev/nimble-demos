...
Introducing auxiliary variables $\xi_1, \ldots, \xi_n$ that indicate which component of the mixture generates each observations, and integrating over the random meassure $G$, we obtain the CRP representation of the model @blackwell_mcqueen_73:
$$
...
# plots: 
hist(probY70,  xlab = "Probability", ylab = "P(tilde(y) > 70 | data)" , main = "" )
```
