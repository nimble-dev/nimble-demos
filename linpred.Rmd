...
In NIMBLE one can specify the linear predictor in a regression-type model in a variety of ways. We'll illustrate
...
Again we need to be careful about dimensionality, converting the matrix-valued result of the matrix
